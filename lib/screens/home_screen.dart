        ...
        children: [
          ...
          SafeArea(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  CircleAvatar(backgroundColor: Colors.white.withValues(alpha: 0.1), child: const Icon(Icons.arrow_back, color: Colors.white)),
                  const Expanded(
                    child: Text(
                      'Daftar Produk',
                  ...
                  Stack(
                    children: [
                      CircleAvatar(backgroundColor: Colors.white.withValues(alpha: 0.1), child: const Icon(Icons.notifications, color: Colors.white)),
